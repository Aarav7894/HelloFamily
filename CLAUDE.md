...
- **No GitHub remote is configured** — this repo is local-only (`git remote -v` is empty). Don't assume a PR workflow or push anywhere without first setting up a remote with the user.
